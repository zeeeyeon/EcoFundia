...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
    ...
    const isProductManagementActive = location.pathname.includes('/project-management');
    const isProductRegistrationActive = location.pathname.includes('/product-registration');
    const isProductSection = isProductManagementActive || isProductRegistrationActive;
