...
import useAuthStore from "../auth/store"; // 경로 수정
// LoadingSpinner는 제거됨
...
const RegisterPage: React.FC = () => {
    ...
    return (
        <>
            ...
            {error && <ErrorMessage message={error} />} {/* ErrorMessage 컴포넌트 사용 */}
            ...
            <div className="registration-page"> {/* CSS 클래스 확인 필요 */}
                <div className="registration-card"> {/* CSS 클래스 확인 필요 */}
                    <div className="leaf-icon"> {/* CSS 클래스 확인 필요 */}
                        <img src={Leaf} alt="Eco Leaf" className="leaf-image" /> {/* CSS 클래스 확인 필요 */}
                    </div>

                    <h1 className="title">판매자 등록</h1> {/* CSS 클래스 확인 필요 */}
                    <p className="description"> {/* CSS 클래스 확인 필요 */}
                        에코펀딩에서 판매자가 되어 친환경 제품을 소개해보세요
                    </p>

                    {user && (
                        <div className="user-info"> {/* CSS 클래스 확인 필요 */}
                            <p>
                    ...
                    <form onSubmit={handleSubmit} className="registration-form"> {/* CSS 클래스 확인 필요 */}
                        <div className="form-group"> {/* CSS 클래스 확인 필요 */}
                        ...
                        <div className="warning-box"> {/* CSS 클래스 확인 필요 */}
                            <h3>판매자 주의사항</h3>
                            <ul>
                        ...
                        <div className="agreement-box"> {/* CSS 클래스 확인 필요 */}
                            <label className="checkbox-label"> {/* CSS 클래스 확인 필요 */}
                                <input
                                    type="checkbox"
                                    checked={agreed}
                        ...
                        >
                            {loading ? <span className="button-loading"></span> : "등록하기"} {/* CSS 클래스 확인 필요 */}
                        </button>
                    </form>
                </div>
            </div>
