    ...
    <table className="product-table" style={{ height: "100%" }}>
      <thead>
        <tr>
          ...
          <th style={{ width: "35%", textAlign: "center" }}>상품명</th>
          <th style={{ width: "20%", textAlign: "center" }}>가격</th>
          <th style={{ width: "15%", textAlign: "center" }}>총 펀딩률</th>
        </tr>
      </thead>
      <tbody>
          ...
          top5Products.map((product) => (
            ...
            >
              ...
              <td style={{ width: "20%", textAlign: "center" }}>
                {formatCurrency(product.totalFundingAmount)}
              </td>
              <td
                style={{ width: "15%", textAlign: "center" }}
                className="funding-rate-cell"
              >
                <span
                  className={`rate-value ${
                    product.fundingRate >= 100 ? "high-rate" : ""
                  }`}
                >
                  +{product.fundingRate}%
                </span>
