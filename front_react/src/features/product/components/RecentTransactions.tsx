...
import { getDummyTransactions, Transaction } from '../api/productService';
                ...
                <table className="transactions-table">
                    ...
                    <tbody>
                            ...
                            <tr key={transaction.id}>
                                <td>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        <div style={{
                                            backgroundColor: (transaction.id % 2 === 0) ? '#E6F1FD' : '#EDEEFC',
                                            width: '32px',
                                            height: '32px',
                                            borderRadius: '50%',
                                            display: 'flex',
                        ...
                        {transactionsToShow.length === 0 && totalItems === 0 && (
                            <tr>
                                <td colSpan={4} className="no-data-message">결제 내역이 없습니다.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
