...
const useProjectList = (projectType: ProjectType) => {
    ...
    const stateSelectors = {
        ...
        finished: {
            ...
            currentPage: (state: ProjectManagementState) => state.finished.currentPage,
            isLoading: (state: ProjectManagementState) => state.finished.isLoading,
            error: (state: ProjectManagementState) => state.finished.error,
            hasNextPage: (state: ProjectManagementState) => state.finished.hasNextPage,
    ...
    }, [currentPage, fetchFunction, projectType, setLoading, setProjects, setError]);
